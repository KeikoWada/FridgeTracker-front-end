...
var listEvents = __webpack_require__(17);
...
var onCreateList = function onCreateList(event) {
  ...
  api.create(data).then(function () {
    return api.showAll(event);
  }).then($('.content').empty()).then(ui.onCreateSuccess).catch(ui.onCreatefailure);
};
...
var onUpdate = function onUpdate(event) {
  ...
  api.updateList(data).then(function () {
    return api.showAll(event);
  }).then($('.content').empty()).then(ui.onUpdateSuccess).catch(ui.onUpdateFailure);
};

var onShowAll = function onShowAll(event) {
  api.showAll(event).then($('.content').empty()).then(ui.onShowAllSuccess).catch(ui.onShowAllFailure);
};

var onShowbyId = function onShowbyId(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // store.data = data
  // console.log(data)
  ...
  .then($('.content').empty()).then(ui.onGetOneSuccess).catch(ui.onGetListFailure);
};

var onOneLoad = function onOneLoad(event) {
  event.preventDefault();

  // grab the `data-id` attribute
  var id = event.target.dataset.id;
  api.load(id).then(ui.getOne);
};
...
var onDeleteList = function onDeleteList(event) {
  ...
  api.deleteList(id).then(function () {
    return api.showAll(event);
  }).then($('.content').empty()).then(ui.removeList) // after deleting a list, refetch all lists
  .catch(ui.failure);
};
...
var showlistsTemplate = __webpack_require__(20);
var showlistTemplate = __webpack_require__(37);

var onCreateSuccess = function onCreateSuccess(data) {
  store.data = data;
  var showlistsHtml = showlistsTemplate({ lists: data.expiration_dates });
...
var onGetOneSuccess = function onGetOneSuccess(data) {
  ...
  var showlistHtml = showlistTemplate({ list: data.expiration_date });
  $('#content').append(showlistHtml);
  $('#messageTwo').dequeue();
};

var onGetListFailure = function onGetListFailure() {
  $('input').val('');
  $('#byIdmyModal').modal('hide');
  $('#failureModal').modal('show');
  $('#messageTwo').dequeue();
...
var getOne = function getOne(data) {
  store.data = data;
  // console.log(data)
...
var removeList = function removeList(data) {
  store.data = data;
  var showlistsHtml = showlistsTemplate({ lists: data.expiration_dates });
  $('#content').append(showlistsHtml);
  // console.log(data.expiration_dates)
...
module.exports = {
  ...
  onGetListFailure: onGetListFailure,
  getOne: getOne
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <ul class=\"list-unstyled\">\n      <li class=\"list-group-date\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.item_name : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\">  Category: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.category : stack1), depth0))
    + " </li>\n      <!-- <button id=\"edit\" class=\"btn btn-default\">Edit item</button>\n      <button id=\"remove\" class=\"btn btn-default\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">delete this list</button> -->\n      <button class=\"list-delete\" data-id="
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        Remove\n      </button>\n      <!-- <button class=\"list-update\" data-id="
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        update\n      </button> -->\n      <button type=\"submit\" data-id="
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + " class=\"list-update\" class=\"btn btn-primary btn-lg\" data-backdrop=\"static\" data-keyboard=\"false\" data-toggle=\"modal\" data-target=\"#thisupdatemyModal\">\n      Update List\n    </button>\n</div>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <div>\n    <ul>\n      <li class=\"list-group-date\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">Expiration Date: N/A </li>\n      <li class=\"list-group-item\"> ID : "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> Item : "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.item_name : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\">  Category: "
  ...
  return "\n<ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.lists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</ul>\n\n\n\n\n\n<div class=\"modal fade\" id=\"thisupdatemyModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"gridSystemModalLabel\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n        <h4 class=\"modal-title\" id=\"gridSystemModalLabel\">Update a List</h4>\n      </div>\n      <div class=\"modal-body\">\n        <!-- content within a model of create list -->\n        <form id=\"updateHtml\">\n          <div class=\"form-group\">\n            <label for=\"list_id\">List ID</label>\n            <input type=\"number\" class=\"form-control oneId\" id=\"\" name=\"list[id]\" placeholder=\"ID\" disabled>\n          </div>\n          <div class=\"form-group\">\n            <label for=\"expiration date\">Expiration Date</label>\n            <input type=\"date\" class=\"form-control oneDate\" id=\"expiration\" name=expiration_date[date] placeholder=\"YYYY-MM-DD\" required>\n          </div>\n          <div class=\"form-group\">\n            <label for=\"item\">Item</label>\n            <input type=\"text\" class=\"form-control oneItem\" id=\"item_name\" name=\"expiration_date[item_name]\" placeholder=\"Item Name\" required>\n          </div>\n          <div class=\"form-group\">\n            <label for=\"category\">Category</label>\n            <input type=\"text\" class=\"form-control oneCategory\" id=\"category_name\" name=\"expiration_date[category]\" placeholder=\"Category\" required>\n            <!-- content within a model of create list end -->\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-default cancel\" data-dismiss=\"modal\">Cancel</button>\n              <button type=\"submit\" class=\"toupdate\" class=\"btn btn-default\">Update list</button>\n            </div>\n          </div>\n          <!-- /.modal-content -->\n        </form>\n      </div>\n      <!-- /.modal-dialog -->\n    </div>\n    <!-- /.modal -->\n  </div>\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<ul>\n\n  <div class=\"body\">\n    <ul class=\"list-unstyled\">\n      <li class=\"list-group-date\" data-id=\""
    ...
    + "\">Expiration Date: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.date : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> ID : "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> Item : "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.item_name : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\">  Category: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.category : stack1), depth0))
    + " </li>\n      <!-- <button id=\"edit\" class=\"btn btn-default\">Edit item</button> -->\n      <!-- <button class=\"list-delete\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.expiration_date : depth0)) != null ? stack1.id : stack1), depth0))
    + ">\n        Remove\n      </button> -->\n</div>\n\n</ul>\n";
},"useData":true});
